...
theta_10f = 0.3144                          # 第一关节转动角度幅值
theta_21f = 1.0123                          # 第二关节相对于第一关节转动角度幅值
...
for t in np.arange(dt, time, dt):           # 从0.01秒到结束
    ...
    # if (counter % 30) == 1:
    #     my_file = open('PID_eta_anglechanged.txt', 'a')
    #     text = 'ep_r: %.1f\n' % (100*total_eta)
    #     my_file.write(text)
    #     my_file.close()

    # 保存角度、角速度等变量数据到txt，用于后续绘图对比
    # my_file = open('PID_state_anglechanged.txt', 'a')
...
# plt.savefig('./Figure1_speed_anglechanged.pdf')
# plt.savefig('./Figure1_speed_anglechanged.png')
...
# [label.set_fontname('Times New Roman') for label in labels]
# plt.legend(loc='lower right', prop=font_1, labelspacing=0.1, handletextpad=0.1, borderpad=0.2, handlelength=1.0)
# plt.savefig('./Figure2_angle_anglechanged.pdf')
# plt.savefig('./Figure2_angle_anglechanged.png')
...
# [label.set_fontname('Times New Roman') for label in labels]
# plt.legend(loc='lower right', prop=font_1, labelspacing=0.1, handletextpad=0.1, borderpad=0.2, handlelength=1.0)
# plt.savefig('./Figure3_anglevelocity_anglechanged.pdf')
# plt.savefig('./Figure3_anglevelocity_anglechanged.png')
...
# [label.set_fontname('Times New Roman') for label in labels]
# plt.legend(loc='lower right', prop=font_1, labelspacing=0.1, handletextpad=0.1, borderpad=0.2, handlelength=1.0)
# plt.savefig('./Figure4_acceleration_anglechanged.pdf')
# plt.savefig('./Figure4_acceleration_anglechanged.png')
...
# [label.set_fontname('Times New Roman') for label in labels]
# plt.legend(loc='lower right', prop=font_1, labelspacing=0.1, handletextpad=0.1, borderpad=0.2, handlelength=1.0)
# plt.savefig('./Figure5_torque_anglechanged.pdf')
# plt.savefig('./Figure5_torque_anglechanged.png')
...
# [label.set_fontname('Times New Roman') for label in labels]
# plt.legend(loc='lower right', prop=font_1, labelspacing=0.1, handletextpad=0.1, borderpad=0.2, handlelength=1.0)
# plt.savefig('./Figure6_eta_anglechanged.pdf')
# plt.savefig('./Figure6_eta_anglechanged.png')
